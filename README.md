...
Linux native shell and the daily driver for most cyber security work. Excels at log analysis, file manipulation and chaining tools together using Unix utilities like grep, awk and sed. Most security tools and targets are Linux-based so this is the priority.
